namespace FirstPlugin.Forms
{
    partial class FMATEditor
    {
        ...
        private Switch_Toolbox.Library.Forms.STCheckBox chkboxVisible;
        private Switch_Toolbox.Library.Forms.STLabel label3;
        private Switch_Toolbox.Library.Forms.STTextBox textBoxShaderModel;
        private Switch_Toolbox.Library.Forms.STLabel label2;
        private Switch_Toolbox.Library.Forms.STTextBox textBoxShaderArchive;
        private Switch_Toolbox.Library.Forms.STLabel label1;
        private Switch_Toolbox.Library.Forms.STTextBox textBoxMaterialName;
